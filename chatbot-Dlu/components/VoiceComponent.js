...
const Voices = props => {
  ...
  return (
    <TouchableOpacity style={styles.micro} onPress={startRecognizing}>
      <MicroIcons name="mic" color="white" size={20} />
      <Modal animationType="slide" transparent={true} visible={Isvisible}>
        <View style={styles.container}>
          <Text style={styles.text}>Bot Dlu</Text>
          <LottieView
            style={styles.gifBot}
            source={require('../Assets/28832-bot.json')}
            autoPlay
            loop
          />
          <View style={styles.containerWatting}>
            ...
            <LottieView
              style={styles.gifWatting}
              source={require('../Assets/13531-loading-bar-dotted-bar-colorful.json')}
              autoPlay
              loop
            />
          </View>
          ...
          <LottieView
            style={styles.gifImg}
            source={require('../Assets/7833-voice.json')}
            autoPlay
            loop
          />
        </View>
