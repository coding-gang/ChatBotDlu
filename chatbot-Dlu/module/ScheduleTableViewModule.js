...
export function ScheduleTableView(data) {
        ...
        const messageMonning = "Sáng: ";
              if(schedule.emptyMorning !== NO_CLASS){
                for(const morning of schedule.morning){
                  ...
                  arrScheduleDate.push(messageMonning);
                } 
               }                        
        ...
        if(schedule.emptyAfternoon !==NO_CLASS){
          for(const afternoon of schedule.afternoon){
            ...
            arrScheduleDate.push(messageBotAfternoon);
          }
        }
        const messageBotEvening = "Tối: ";
              if(schedule.emptyEveningNoon !==NO_CLASS){
                ...
                arrScheduleDate.push(messageBotEvening);
                }
              }
              objSchedule[schedule.thu] = arrScheduleDate
              arrMessage.push(objSchedule);
        }
        return arrMessage;
      }
